...
#define DEFAULT_MINIMUMFEEDRATE       2.0     // (mm/s) Minimum feedrate. Set with M205 S.
#define DEFAULT_MINTRAVELFEEDRATE    2.0     // (mm/s) Minimum travel feedrate. Set with M205 T.
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       2100   // (mA) RMS current. Multiply by 1.414 for peak current.
...
// TMC2209
  ...
  //#define CHOPPER_TIMING_X2 CHOPPER_DEFAULT_36V
  ...
  #define X_HYBRID_THRESHOLD     15  // [mm/s]
   ...
   * Connect the stepper driver's DIAG1 pin to the X/Y 
   * 
   *  pin.
...
#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
     ...
     */
    #define SPEED_POWER_INTERCEPT         2    // (%) 0-100 i.e., Minimum power percentage
    ...
    #define SPEED_POWER_MAX             45  // (%) 0-100

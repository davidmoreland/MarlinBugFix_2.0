/**  Test Log
  * 
  * Dave Moreland  
  * Z worked running 2 steppers of single TMC5160 on GTR Main board
  * Trying to get X 'single' to work... very erratic.
  * if get 'single' working... will 1st try second stepper driver, if not successful, will you parallel wire
  * 
  ** /
...
#define STRING_CONFIG_H_AUTHOR "(dcm, dec292020-2:45pm)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 2560, 2560, 500 }
...
#define DEFAULT_MAX_ACCELERATION      { 2, 2, 2, 10000 }
